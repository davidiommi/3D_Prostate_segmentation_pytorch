...
parser.add_argument("--image", type=str, default='./Data_folder/MR/Patient_38_MR.mha')
parser.add_argument("--label", type=str, default=None)
parser.add_argument("--result", type=str, default='./Data_folder/MR_masks/Patient_38_MR_mask.mha', help='path to the .nii result to save')
